...
class EnsIngestor(Ingestor):
    ...
    def ingest_ens(self):
        ...
        urls = self.save_json_as_csv(self.scraper_data["ens"], f"ingestor_ens_{self.asOf}")
        ...
        urls = self.save_json_as_csv(self.scraper_data["primary"], f"ingestor_primary_{self.asOf}")

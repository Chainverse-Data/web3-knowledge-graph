...
class EnsIngestor(Ingestor):
    ...
    def ingest_ens(self):
        ...
        urls = self.save_json_as_csv(self.scraper_data["ens"], self.bucket_name, f"ingestor_ens_{self.asOf}")
        ...
        urls = self.save_json_as_csv(self.scraper_data["primary"], self.bucket_name, f"ingestor_primary_{self.asOf}")

...
dag = DAG(
    "mirror_nft_processing",
    description="Scrapes the latest Mirror NFT collectors, and ingest them into the neo4J instance.",
    default_args={
...
mirror_process_task = ECSOperator(
    ...
    overrides={
        "containerOverrides": [
            {
                "name": "data-pipelines",
                "command": ["python3", "-m", "pipelines.postProcessing.mirrorNFT.process"],

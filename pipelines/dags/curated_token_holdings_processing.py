...
dag = DAG(
    "curated_tokens_holding_processing",
...
ecs_task_definition_metadata = "pipelines-highcpu"
...
curated_tokens_holding_processing_task = ECSOperator(
    task_id="curated_tokens_holding_processing",
    dag=dag,
    aws_conn_id="aws_ecs",
    cluster=ecs_cluster,
...
curated_tokens_holding_processing_task
...
dag = DAG(
    "ENS_text_record_lookup",
    description="Gets the text record data for all ENS nodes.",
    default_args={
...
ensLookup_post_processing_task = ECSOperator(
    task_id="ensLookup_post_processing",
    dag=dag,
    aws_conn_id="aws_ecs",
    cluster=ecs_cluster,
...
ensLookup_post_processing_task
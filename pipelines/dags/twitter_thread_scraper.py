...
twitter_thread_scraper_task = ECSOperator(
    task_id="twitter_thread_scraper",
    dag=dag,
    aws_conn_id="aws_ecs",
    cluster=ecs_cluster,
    ...
    overrides={
        "containerOverrides": [
            {
                "name": "data-pipelines",
                "command": ["python3", "-m", "pipelines.postProcessing.twitterThreads.process"],

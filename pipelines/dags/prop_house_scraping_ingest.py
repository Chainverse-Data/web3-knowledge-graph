...
dag = DAG(
    "prop_house_scraping_and_ingest",
    description="Scrapes the latest Prop House data, and ingest them into the neo4J instance.",
    default_args={
...
prop_house_scrape_task = ECSOperator(
    task_id="prop_house_scraping",
    dag=dag,
    aws_conn_id="aws_ecs",
    cluster=ecs_cluster,
...
prop_house_ingest_task = ECSOperator(
    task_id="prop_house_ingesting",
    dag=dag,
    aws_conn_id="aws_ecs",
    cluster=ecs_cluster,
    task_definition=ecs_task_definition,
...
prop_house_scrape_task >> prop_house_ingest_task
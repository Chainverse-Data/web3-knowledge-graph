...
wic_incentive_farming >> [wic_creators, wic_collectors, wic_traders, wic_developers, wic_protocol_politicians, wic_professionals, wic_influencers, wic_public_goods] >> audiences_post_processing_task
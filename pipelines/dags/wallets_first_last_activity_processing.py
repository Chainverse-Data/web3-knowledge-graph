...
ecs_task_definition_processing = "pipelines-large"
...
env_vars = [
    ...
    {"name": "ALCHEMY_API_KEY", "value": Variable.get("ALCHEMY_API_KEY_OPTIMISM")},
    {"name": "ALCHEMY_API_KEY", "value": Variable.get("ALCHEMY_API_KEY_ARBITRUM")},
    {"name": "ALCHEMY_API_KEY", "value": Variable.get("ALCHEMY_API_KEY_SOLANA")},
    {"name": "ALCHEMY_API_KEY", "value": Variable.get("ALCHEMY_API_KEY_POLYGON")},
